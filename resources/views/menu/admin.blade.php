                    ...
                    <ul class="treeview-menu">
                        ...
                        @if(Sentinel::hasAccess('clients.pending_approval'))
                            <li><a href="{{ url('client/pending_approval') }}"><i
                                            ...
                                            <span class="pull-right-container">
                                            <span class="label label-info pull-right">{{\App\Models\Loan::where('status','pending')->count() }}</span>
                                    </span>
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('clients.closed'))
                            <li><a href="{{ url('client/closed') }}"><i
                                            ...
                                            <span class="pull-right-container">
                                            <span class="label label-info pull-right">{{\App\Models\Loan::where('status','closed')->count() }}</span>
                                    </span>
                                </a></li>
                        @endif
                        @if(Sentinel::hasAccess('clients.closed'))
